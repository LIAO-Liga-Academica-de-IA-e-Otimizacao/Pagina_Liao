    ...
    return (
        <div className="bg-white rounded-lg shadow-lg p-6">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
                <div>
                    <label className="block text-sm font-medium text-gray-700">Nome da Parceria/Empresa</label>
                    <input
                        type="text"
                        required
                        value={name}
                ...
                <div>
                    ...
                    <input
                        ...
                        className="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500"
                    />
                    <p className="text-xs text-gray-500 mt-1">Cole o link da imagem da logo.</p>
                </div>
                ...
                <div>
                    <label className="block text-sm font-medium text-gray-700">Link do Site (Opcional)</label>
                    <input
                        type="url"
                        value={websiteUrl}
                        ...
                        className="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500"
                    />
                    <p className="text-xs text-gray-500 mt-1">Link para onde o usuário será redirecionado ao clicar.</p>
                </div>
