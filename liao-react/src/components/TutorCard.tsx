...
const TutorCard: React.FC<TutorCardProps> = ({ tutor }) => {
    return (
        <div
            className="group relative rounded-2xl p-[2px] bg-gradient-to-br from-red-500 via-yellow-400 to-green-500 hover:shadow-2xl hover:scale-105 transition-all duration-300 cursor-pointer"
        >
