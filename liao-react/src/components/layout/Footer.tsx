                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                    ...
                    <div>
                        ...
                        <ul className="space-y-2">
                            <li>
                                <Link to="/members" className="text-neutral-400 hover:text-white transition-colors">
                                    Membros
                                </Link>
                            </li>
                            <li>
                                <Link to="/tutors" className="text-neutral-400 hover:text-white transition-colors">
                                    Tutores
                                </Link>
                            </li>
                            <li>
                                <Link to="/prosel" className="text-neutral-400 hover:text-white transition-colors">
                                    Processo Seletivo
                                </Link>
                            </li>
                            <li>
                        ...
                        <ul className="space-y-4 text-neutral-400">
                            ...
                            <li>
                                <Link to="/login" className="flex items-center gap-2 hover:text-white transition-colors">
                                    <span className="text-xs bg-neutral-800 px-2 py-1 rounded border border-neutral-700">Admin</span>
