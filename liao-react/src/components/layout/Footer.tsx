        ...
        <footer className="bg-neutral-100 text-neutral-800 dark:bg-neutral-950 dark:text-neutral-200 border-t border-neutral-200 dark:border-neutral-900 mt-auto transition-colors duration-200">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                    {/* About */}
                    <div>
                        <h3 className="text-xl font-bold mb-4 text-neutral-900 dark:text-white">LIAO</h3>
                    ...
                    <div>
                        ...
                        <ul className="space-y-2">
                            ...
                            <li>
                                <Link to="/tutors" className="text-neutral-600 dark:text-neutral-400 hover:text-primary-800 dark:hover:text-white transition-colors">
                                    Tutores
                                </Link>
                            </li>
                            <li>
