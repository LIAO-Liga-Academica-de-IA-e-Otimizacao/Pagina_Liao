        ...
        <div className="min-h-screen bg-gray-50 py-12">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="flex flex-col md:flex-row justify-between items-center mb-12 gap-4">
                    <h1 className="section-title mb-4 md:mb-0">Projetos Realizados</h1>
                ...
                <div className={getContainerClass()}>
                    {projects.map((project) => (
                        <div
                            ...
                            className={`
                                group bg-white rounded-lg border border-gray-100 overflow-hidden hover:shadow-xl transition-all duration-300 cursor-pointer
                        ...
                        >
                            ...
                            `}>
                                ...
                                <h3 className={`
                                    font-bold text-gray-900 leading-tight group-hover:text-blue-600 transition-colors
                                ...
                                {viewMode !== 'grid' && (
                                    <p className={`text-gray-600 line-clamp-3 flex-1 leading-relaxed text-sm ${viewMode === 'list' ? 'mb-2' : 'mb-6'}`}>
                                        {project.description}
                                    </p>
                                )}
