        ...
        return (
            <div className="min-h-screen bg-neutral-50 flex flex-col items-center justify-center px-4">
                <div className="text-center">
                    <h2 className="text-3xl font-extrabold text-neutral-900 mb-4">Ops!</h2>
                    <p className="text-xl text-neutral-600 mb-8">{error || 'Tutor não encontrado.'}</p>
                    <button
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 divide-y md:divide-y-0 md:divide-x divide-neutral-100">
                        ...
                        <div className="col-span-2 p-8 md:p-12">
                            <h2 className="text-2xl font-bold text-neutral-900 mb-6 flex items-center gap-2">
                                <svg className="w-6 h-6 text-primary-600" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z" /></svg>
                            ...
                            <div className="prose prose-lg text-neutral-600 leading-relaxed text-justify">
                                {tutor.bio ? (
                                    ...
                                    <p className="italic text-neutral-400">Nenhuma biografia disponível.</p>
                                )}
                            </div>
                        </div>

                        {/* Sidebar Info */}
                        <div className="col-span-1 bg-neutral-50 p-8 md:p-12">
                            {/* Disciplinas */}
                            <div className="mb-8">
                                ...
                                <div className="flex flex-wrap gap-2">
                                    {tutor.subjects && tutor.subjects.length > 0 ? (
                                        tutor.subjects.map((subject, index) => (
                                            <span
                                                key={index}
                                                className="inline-block px-3 py-1 bg-white border border-primary-100 text-primary-700 rounded-full text-sm font-semibold shadow-sm"
                                            >
                                                {subject}
                                            </span>
                                        ))
                                    ) : (
                                        <span className="text-neutral-500 text-sm">Não informado</span>
                                    )}
                                </div>
                            </div>
                            ...
                            {/* Contact/CTA */}
                            <div>
                                <h3 className="text-lg font-bold text-neutral-900 mb-4">Contato</h3>
                                <a
